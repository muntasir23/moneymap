...
export default function EachSlide({ cata, budget, totalCost, persentage }) {
  ...
  console.log("the type of " + typeof(totalCost)); 
  console.log("the width persentage is" + widthPersentage);
  ...
  return (
    <div className="bg-gray-900 h-[120px] rounded p-3">
      ...
      <div className="w-[100%] h-[10px] bg-gray-700 rounded-[4px] overflow-hidden">
        <div
          className={`h-[100%] bg-lime-300  rounded-[4px]`}
